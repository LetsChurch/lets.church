...
function mockProbe(width: number, height: number, codec_name = 'h264') {
  return {
    streams: [
      {
...
test('variantsToMasterVideoPlaylist', () => {
  expect(
    variantsToMasterVideoPlaylist(['VIDEO_4K', 'VIDEO_1080P']),
...
test('ffmpegEncodingArgs', () => {
  expect(
    ...
    [
      "-filter_complex",
      "[0:v]scale=3840x2160,setsar=1[VIDEO_4K];[0:v]scale=1920x1080,setsar=1[VIDEO_1080P];[VIDEO_4K]split[VIDEO_4K_DOWNLOAD][VIDEO_4K];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_4K]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "[0:v]scale=1920x1080,setsar=1[VIDEO_1080P];[0:v]scale=1280x720,setsar=1[VIDEO_720P];[0:v]scale=960x540,setsar=1[VIDEO_480P];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_1080P]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "scaler_ama=outputs=2:out_res=(3840x2160)(1920x1080) [VIDEO_4K][VIDEO_1080P];[VIDEO_4K]split[VIDEO_4K_DOWNLOAD][VIDEO_4K];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_4K]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "scaler_ama=outputs=3:out_res=(1920x1080)(1280x720)(960x540) [VIDEO_1080P][VIDEO_720P][VIDEO_480P];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_1080P]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "hwupload,scaler_ama=outputs=2:out_res=(3840x2160)(1920x1080) [VIDEO_4K][VIDEO_1080P];[VIDEO_4K]split[VIDEO_4K_DOWNLOAD][VIDEO_4K];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_4K]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "hwupload,scaler_ama=outputs=3:out_res=(1920x1080)(1280x720)(960x540) [VIDEO_1080P][VIDEO_720P][VIDEO_480P];[VIDEO_1080P]split[VIDEO_1080P_DOWNLOAD][VIDEO_1080P]",
      "-map",
      "[VIDEO_1080P]",
      "-map",
      "0:a",
