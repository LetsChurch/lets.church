...
// (seed/bsb/bsb_usx/*.usx). Run with: node scripts/gen-canon.mjs
//
...
const ts = `// AUTO-GENERATED from the BSB USX seed (scripts/gen-canon.mjs). The 66-book
