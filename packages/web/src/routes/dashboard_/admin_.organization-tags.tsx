...
export const Route = createFileRoute('/dashboard_/admin_/organization-tags')({
    ...
    <Container size="lg" py="md">
      <Stack gap="lg">
        ...
        {Object.entries(groupedTags).map(([category, categoryTags]) => (
          <div key={category}>
            ...
            <Table>
              <Table.Thead>
                <Table.Tr>
                  <Table.Th w={TABLE_COLUMN_WIDTHS.TAG}>Tag</Table.Th>
                  <Table.Th w={TABLE_COLUMN_WIDTHS.SLUG}>Slug</Table.Th>
                  <Table.Th w={TABLE_COLUMN_WIDTHS.DESCRIPTION}>
                    Description
                  </Table.Th>
                  <Table.Th w={TABLE_COLUMN_WIDTHS.ACTIONS}>Actions</Table.Th>
                </Table.Tr>
              </Table.Thead>
              <Table.Tbody>
                {categoryTags
                  ...
                  .map((tag) => (
                    <Table.Tr key={tag.slug}>
                      <Table.Td w={TABLE_COLUMN_WIDTHS.TAG}>
                        <Badge
                      ...
                      <Table.Td w={TABLE_COLUMN_WIDTHS.SLUG}>
                        <Text size="sm" c="dimmed">
                          {tag.slug}
                        </Text>
                      </Table.Td>
                      <Table.Td w={TABLE_COLUMN_WIDTHS.DESCRIPTION}>
                        <Text size="sm">{tag.description || '-'}</Text>
                      </Table.Td>
                      <Table.Td w={TABLE_COLUMN_WIDTHS.ACTIONS}>
                        <Group gap="xs">
                          <ActionIcon
                            color="blue"
                            variant="light"
        ...
        <Modal
          ...
          onClose={close}
          title={
            editingTag ? 'Edit Organization Tag' : 'Create Organization Tag'
          }
          size="md"
        >
          <form
