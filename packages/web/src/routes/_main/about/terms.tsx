  ...
  return (
    <article className="prose prose-lg prose-gray dark:prose-invert mx-auto max-w-4xl px-4 py-8">
      ...
      <p>
        ...
        &#8220;you&#8221; or &#8220;your&#8221;) and Let's Church Inc.
        (&#8220;Let's Church Inc.&#8221;, &#8220;we&#8221;, &#8220;us&#8221; or
      ...
      <p>
        ...
        slander, disparage, or intimidate (f) to submit false or misleading
        ...
        pretext (i) for any obscene or immoral purpose; or (j) to interfere with
        or circumvent the security features of the Website and Services, third
      ...
      <p>
        ...
        Service or as to the accuracy or reliability of any information obtained
      ...
      <p>
        ...
        United States. The exclusive jurisdiction and venue for actions related
        to the subject matter hereof shall be the courts located in Delaware,
        United States, and you hereby submit to the personal jurisdiction of
