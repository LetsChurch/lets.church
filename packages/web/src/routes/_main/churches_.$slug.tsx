    ...
    <div className="min-h-screen bg-linear-to-br from-zinc-50 via-white to-indigo-50/30 dark:from-zinc-950 dark:via-zinc-900 dark:to-indigo-950/20">
      ...
      {church.coverUrl ? (
        <div className="relative h-80 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-white dark:to-zinc-900" />
        </div>
      ) : (
        <div
          className={`relative h-48 overflow-hidden bg-linear-to-br ${headerColors.from} ${headerColors.via} ${headerColors.to} dark:${darkHeaderColors.from} dark:${darkHeaderColors.via} dark:${darkHeaderColors.to}`}
        >
      ...
      <div className="isolate mx-auto max-w-5xl px-6 pb-24">
        ...
        <div className="-mt-16 sm:-mt-20 mb-12">
          <div className="flex items-center overflow-hidden rounded-full bg-white shadow-lg dark:bg-zinc-900">
            <Avatar
