  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center justify-end gap-4">
        <Text size="xs" c="dimmed">
          OpenAI Flex content-filter responses retry live through OpenRouter
          using <Code>OPENROUTER_ANNOTATE_FALLBACK_MODEL</Code>. Both attempts
          are recorded in <Code>llm_call</Code>.
        </Text>
      </div>
    </div>
  );
