...
- questions: Questions to answer for the user. Include BOTH literal questions AND non-interrogative information needs that call for a synthesized, multi-source answer — an explanation, examples, a comparison, or "what Scripture/teaching says about X". Reformulate such a need into the natural question it implies (e.g. "Bible examples of free, grace-based giving" -> "What are some Bible examples of free, grace-based giving?"; "passages about suffering and hope" -> "What do the Scriptures say about suffering and hope?"). ALSO treat identity/definition questions as questions — an interrogative "who is X", "what is X", or "tell me about X" about a person, ministry, book, or term genuinely asks for an answer, even when X is a speaker (e.g. "Who is Conley Owens?" -> "Who is Conley Owens?"; "what is the dorean principle" -> "What is the Dorean Principle?"). Do NOT treat as questions: BARE navigational lookups that are just a name or source with no interrogative (e.g. "Conley Owens", "Apologia Studios", "the dorean principle"), requests to browse or list media, or bare topic/keyword queries where a plain list of videos is the natural result. Use null when none applies.
...
/**
 * Parse a raw search query into structured fields with gpt-6-luna. Always
