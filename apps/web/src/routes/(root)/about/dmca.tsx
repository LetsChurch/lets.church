    ...
    <div class="bg-white px-6 py-3 lg:px-8">
      <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <P>
          ...
          and outlines how Let's Church Inc. (&#8220;Let's Church Inc.&#8221;,
        ...
        <P>
          ...
          our users, if you knowingly misrepresent that the material or activity
        ...
        <H2 id="notifications-of-infringement">
          Notifications of infringement
        </H2>
        <P>
          ...
          to the DMCA by providing us with the following information:
        </P>
        <ul>
          <li>
        ...
        <P>
          ...
          this Policy, Let's Church Inc. reserves the right to take no action
          upon receipt of a DMCA copyright infringement notification if it fails
          to comply with all the requirements of the DMCA for such
          notifications.
        </P>
        ...
        <P>
          ...
          Copyright Act. If you receive a copyright infringement Notification,
          it means that the material described in the Notification has been
          removed from our Services or access to the material has been
          restricted. Please take the time to read through the Notification,
          which includes information on the Notification we received as well as
          instructions on how to file a counter-notifications.
        </P>
        <P>
          To file a counter-notification with us, you must provide a written
          communication that sets out the information specified in the list
          below:
        </P>
        <ul>
          <li>
            Identification of the material that has been removed or to which
            access has been restricted and the location at which the material
            appeared before it was removed or access to it was restricted.
          </li>
          <li>
            Information reasonably sufficient to permit us to contact you, such
            as an address, telephone number, and, if available, an e-mail
          ...
          <li>
            ...
            belief that the material was removed or restricted as a result of
          ...
          <li>
            ...
            located (or if you are outside of the United States, that you
            consent to the jurisdiction of any judicial district in which the
        ...
        <P>
          ...
          restricted by mistake or misidentification. Accordingly, if you are
          not sure whether certain material infringes the copyrights of others
          or that the material or activity was removed or restricted by mistake
          or misidentification, you may wish to contact an attorney before
          filing a counter-notification.
        </P>
        <P>
          Notwithstanding anything to the contrary contained in any portion of
          this Policy, Let's Church Inc. reserves the right to take no action
          upon receipt of a counter-notification. If we receive a
