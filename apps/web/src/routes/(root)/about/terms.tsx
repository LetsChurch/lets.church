    ...
    <div class="bg-white px-6 py-3 lg:px-8">
      <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <P>
          ...
          a contract between you and Let's Church Inc., even though it is
        ...
        <P>
          ...
          harm, defame, slander, disparage, or intimidate (f) to submit false or
          ...
          affect the functionality or operation of the Website and Services,
          third party products and services, or the Internet; (h) to spam,
          phish, pharm, pretext (i) for any obscene or immoral purpose; or (j)
          to interfere with or circumvent the security features of the Website
          and Services, third party products and services, or the Internet. We
        ...
        <P>
          ...
          and procedural laws of Delaware, United States without regard to its
          ...
          located in Delaware, United States, and you hereby submit to the
        ...
        <P>
          ...
          will revise the updated date at the bottom of this page and send you
