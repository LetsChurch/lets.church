  ...
  return (
    <>
      ...
      <p>
        ...
        outlines how Let's Church Inc. (&#8220;Let's Church Inc.&#8221;,
      ...
      <div>
        ...
        <ol className="mt-4 max-w-xl space-y-2 text-gray-600">
          <li>
      ...
      <p>
        ...
        copyright holder. If you have considered fair use, and you still wish to
      ...
      <ul>
        <li>
          ...
          Notification, you may provide a representative list of the copyrighted
          works that you claim have been infringed.
        </li>
        <li>
          Identification of the infringing material and information you claim is
          infringing (or the subject of infringing activity), including at a
          minimum, if applicable, the URL or URLs of the web pages where the
        ...
        <li>
          ...
          suffice) of the copyright owner or a person authorized to act on their
          behalf.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        means that the material described in the Notification has been removed
        from our Services or access to the material has been restricted. Please
      ...
      <ul>
        ...
        <li>
          ...
          that the material was removed or restricted as a result of mistake or
          misidentification of the material to be removed or restricted.
        </li>
        <li>
          ...
          located (or if you are outside of the United States, that you consent
          to the jurisdiction of any judicial district in which the service
          provider may be found), and that you will accept service of process
          from the person or company who provided the original infringement
          notification.
        </li>
        <li>
          A physical or electronic signature (typing your full name will
      ...
      <p>
        ...
        restricted by mistake or misidentification. Accordingly, if you are not
        sure whether certain material infringes the copyrights of others or that
