...
# css
watchexec --watch app --exts css -- "npx lightningcss-cli --minify --bundle --targets 'last 2 versions' app/index.css -o assets/styles.css" &

# built assets
watchexec --watch assets -- templ generate --notify-proxy --proxybind=0.0.0.0 --proxyport=3001 &
