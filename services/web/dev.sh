...
# css
watchexec --watch internal --exts css -- "npx lightningcss-cli --minify --bundle --custom-media --targets 'last 2 versions and not dead' cmd/server/index.css cmd/server/components/player.css --output-dir cmd/server/assets" &
