...
test('ffmpegEncodingOutputArgs', () => {
  ...
  expect(
    ...
    [
      "-filter_complex",
      "scaler_ama=outputs=4:out_res=(1920x1080),(1280x720),(842x480),(640x360) [VIDEO_1080P],[VIDEO_720P],[VIDEO_480P],[VIDEO_360P]",
      "-map",
      "[VIDEO_1080P]",
      "-map",
      "0:a",
  ...
  expect(
    ...
    [
      "-filter_complex",
      "hwupload,scaler_ama=outputs=4:out_res=(1920x1080),(1280x720),(842x480),(640x360) [VIDEO_1080P],[VIDEO_720P],[VIDEO_480P],[VIDEO_360P]",
      "-map",
      "[VIDEO_1080P]",
      "-map",
      "0:a",
