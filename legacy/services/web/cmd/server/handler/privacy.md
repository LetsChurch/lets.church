...
We respect your privacy and are committed to protecting it through our compliance with this privacy policy ("Policy"). This Policy describes the types of information we may collect from you or that you may provide ("Personal Information") on the [lets.church](https://lets.church) website ("Website" or "Service") and any of its related products and services (collectively, "Services"), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.

This Policy is a legally binding agreement between you ("User", "you" or "your") and Let's Church Inc. ("Let's Church Inc.", "we", "us" or "our"). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms "User", "you" or "your" shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.

### Table of contents

1. [Automatic collection of information](#collection)
1. [Collection of personal information](#personal)
1. [Privacy of children](#children)
1. [Use and processing of collected information](#processing)
1. [Managing information](#management)
1. [Disclosure of information](#disclosure)
1. [Retention of information](#retention)
1. [Transfer of information](#transfer)
1. [Data protection rights under the GDPR](#gdpr)
1. [California privacy rights](#california)
1. [How to exercise your rights](#rights)
1. [Cookies](#cookies)
1. [Data analytics](#analytics)
1. [Do Not Track signals](#dnt)
1. [Social media features](#social)
1. [Links to other resources](#links)
1. [Information security](#security)
1. [Data breach](#breach)
1. [Changes and amendments](#changes)
1. [Acceptance of this policy](#acceptance)
1. [Contacting us](#contact)

## Automatic collection of information {#collection}
...
## Use and processing of collected information {#processing}
...
Depending on your location, data transfers may involve transferring and storing your information in a country other than your own, including the United States. The transfer of your Personal Information to countries outside the European Union will be made only if you have explicitly consented to it or in the cases provided for by the GDPR and will be processed in your interest.
...
## Data protection rights under the GDPR {#gdpr}
...
## Links to other resources {#links}
...
## Acceptance of this policy {#acceptance}
...
[Submit a data access request](https://app.websitepolicies.com/dsar/view/jgslzas4)
