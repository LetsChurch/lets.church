...
# javascript
npx esbuild cmd/server/index.ts cmd/server/components/player.ts cmd/server/components/transcript.ts --bundle --splitting --format=esm --outdir=cmd/server/assets --watch=forever &
